...
const ICONS: Readonly<Record<IconName, IconDef>> = {
  ...
  // A hollow lozenge. It is the shape the board already draws on a warded card,
  // kept identical so the mark and its explanation are the same object.
  ward: {
    shape: 'a hollow diamond',
    fillRule: 'evenodd',
    d: 'M12 1.4 L22.6 12 L12 22.6 L1.4 12 Z M12 6.1 L6.1 12 L12 17.9 L17.9 12 Z',
  },
